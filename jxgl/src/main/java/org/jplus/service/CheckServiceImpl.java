...
//        BkssjjxInfo bkssjjxInfo = checkMapper.getBKSSJJXInfo(gh);
    ...
    @Override
    public void setShztByOfficeY(String gh, String userName, Timestamp date){
        checkMapper.setShztByOfficeY(gh,userName,date);
    }
    ...
    public void setShztByDepartmentsY(String gh, String uname, Timestamp date) {
        checkMapper.setShztByDepartmentsY(gh,uname,date);
    }
