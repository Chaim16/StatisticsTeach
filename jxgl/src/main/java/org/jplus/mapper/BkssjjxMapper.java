...
public interface BkssjjxMapper {
    ...
    @Select("select gh,nd,sxlxbm1,sxts1,sxlxbm2,sxts2,sxlxbm3,sxts3,wgsjrs,zylxbm,zdlwrs,glnr,glgzl,gzl from bkssjjx where gh=#{gh} and nd=#{xqnd}")
    ...
    @Update("update bkssjjx set nd=#{nd},sxlxbm1=#{sxlxbm1},sxts1=#{sxts1},sxlxbm2=#{sxlxbm2},sxts2=#{sxts2}," +
            ...
            "glnr=#{glnr},glgzl=#{glgzl},gzl=#{gzl} where gh=#{gh} and nd = #{nd}")
