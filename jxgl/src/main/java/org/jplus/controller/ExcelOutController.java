...
public class ExcelOutController {
    ...
    /* 设置边框 */
    public static void setBorder(CellRangeAddress cellRangeAddress, Sheet sheet, Workbook workbook){
        /*设置四周的边框*/
    ...
    public void QXexcelOut(HttpServletRequest request, HttpServletResponse response, Users users) {
        ...
        CellRangeAddress cellRangeAddress1 = new CellRangeAddress(0, 2, 0, 16);
        workLoad.addMergedRegion(cellRangeAddress1);
        cell.setCellStyle(cellStyle1);
        cell.setCellValue("湖北师范大学"+ GetYear.getCurrentYear() +"年度教师教学工作量统计表");
        ...
        ExcelOutController.setBorder(cellRangeAddress, workLoad, sheets);
        ExcelOutController.setBorder(cellAddresses_1, workLoad, sheets);
        ExcelOutController.setBorder(cellAddresses_100, workLoad, sheets);
        ExcelOutController.setBorder(cellAddresses_2,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_3,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_4,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_5,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_6,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_7,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_8,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_9,workLoad,sheets);
        ...
        List<Tjb> tjbs = null;
        if(users.getActor()==2){
             tjbs = tjbService.getAllTjbByYxbm(users.getYxbm(), GetYear.getCurrentYear());
        }else {
             tjbs = tjbService.getAllTjb(GetYear.getCurrentYear());
        }
 ...
 /*导出全校*/
    @NeedLogin
    @RequestMapping("QXexcelOut2")
    public void QXexcelOut2(HttpServletRequest request, HttpServletResponse response, Users users) {
        /*创建Excel，设置基本样式*/
        HSSFWorkbook sheets = new HSSFWorkbook();
        HSSFCellStyle cellStyle = sheets.createCellStyle();
        HSSFFont font = sheets.createFont();
        ...
        workLoad.addMergedRegion(cellRangeAddress1);
        cell.setCellStyle(cellStyle1);
        cell.setCellValue("湖北师范大学"+ GetYear.getCurrentYear() +"年度教师研究生教学工作量统计表");
        ...
        cell_4.setCellValue("研究生教学工作量");
        CellRangeAddress cellAddresses_4 = new CellRangeAddress(3, 3, 4, 9);
        workLoad.addMergedRegion(cellAddresses_4);
        cell_4.setCellStyle(cellStyle);

        HSSFCell cell_5 = row_0.createCell(10);
        cell_5.setCellValue("本科生最低授课");
        CellRangeAddress cellAddresses_5 = new CellRangeAddress(3, 4, 10, 10);
        workLoad.addMergedRegion(cellAddresses_5);
        cell_5.setCellStyle(cellStyle);

        HSSFCell cell_6 = row_0.createCell(11);
        cell_6.setCellValue("额定教学工作量");
        CellRangeAddress cellAddresses_6 = new CellRangeAddress(3, 4, 11, 11);
        workLoad.addMergedRegion(cellAddresses_6);
        cell_6.setCellStyle(cellStyle);


        HSSFCell cell_7 = row_0.createCell(12);
        cell_7.setCellValue("实际教学工作量");
        CellRangeAddress cellAddresses_7 = new CellRangeAddress(3, 4, 12, 12);
        workLoad.addMergedRegion(cellAddresses_7);
        cell_7.setCellStyle(cellStyle);

        HSSFCell cell_8 = row_0.createCell(13);
        cell_8.setCellValue("本科生授课未完成");
        CellRangeAddress cellAddresses_8 = new CellRangeAddress(3, 4, 13, 13);
        workLoad.addMergedRegion(cellAddresses_8);
        cell_8.setCellStyle(cellStyle);

        HSSFCell cell_9 = row_0.createCell(14);
        cell_9.setCellValue("额定教学未完成");
        CellRangeAddress cellAddresses_9 = new CellRangeAddress(3, 4, 14, 14);
        workLoad.addMergedRegion(cellAddresses_9);
        cell_9.setCellStyle(cellStyle);

        HSSFCell cell_10 = row_0.createCell(15);
        cell_10.setCellValue("本科生工作量提交状态");
        CellRangeAddress cellAddresses_10 = new CellRangeAddress(3, 4, 15, 15);
        workLoad.addMergedRegion(cellAddresses_10);
        cell_10.setCellStyle(cellStyle);

        HSSFCell cell_11 = row_0.createCell(16);
        cell_11.setCellValue("本科生工作量审核状态");
        CellRangeAddress cellAddresses_11 = new CellRangeAddress(3, 4, 16, 16);
        workLoad.addMergedRegion(cellAddresses_11);
        cell_11.setCellStyle(cellStyle);

        HSSFRow row_1 = workLoad.createRow(4);


        HSSFCell cell_19 = row_1.createCell(4);
        cell_19.setCellValue("课堂教学");
        cell_19.setCellStyle(cellStyle);

        HSSFCell cell_110 = row_1.createCell(5);
        cell_110.setCellValue("实践教学");
        cell_110.setCellStyle(cellStyle);

        HSSFCell cell_111 = row_1.createCell(6);
        cell_111.setCellValue("学科建设");
        cell_111.setCellStyle(cellStyle);

        HSSFCell cell_112 = row_1.createCell(7);
        cell_112.setCellValue("教研项目");
        cell_112.setCellStyle(cellStyle);

        HSSFCell cell_113 = row_1.createCell(8);
        cell_113.setCellValue("竞赛获奖");
        cell_113.setCellStyle(cellStyle);

        HSSFCell cell_114 = row_1.createCell(9);
        cell_114.setCellValue("其他");
        cell_114.setCellStyle(cellStyle);
        ...
        ExcelOutController.setBorder(cellAddresses_8,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_9,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_10,workLoad,sheets);
        ExcelOutController.setBorder(cellAddresses_11,workLoad,sheets);
        ...
        List<Tjb> tjbs = null;
        if(users.getActor()==2){
             tjbs = tjbService.getAllTjbByYxbm(users.getYxbm(), users.getYxbm());
        }else {
             tjbs = tjbService.getAllTjb(GetYear.getCurrentYear());
        }
        ...
        for (int i = 0; i < tjbs.size(); i++) {
            Tjb tjb = tjbs.get(i);
            Tjzt tjzt = tjztService.getTjzt(tjb.getGh());
            ...
            workLoadRow.createCell(3).setCellValue(tjb.getZw());
            /*研究生课堂教学*/
            workLoadRow.createCell(4).setCellValue(tjb.getYjsktjxgzl());
            /*研究生实践教学*/
            workLoadRow.createCell(5).setCellValue(tjb.getJsjsjjxgzl());
            /*研究生学科建设*/
            workLoadRow.createCell(6).setCellValue(tjb.getXkjsgzl());
            /*研究生教研项目*/
            workLoadRow.createCell(7).setCellValue(tjb.getYjsjyxmgzl() + tjb.getYjshxxmgzl());
            /*研究生竞赛与论文*/
            /*差一个竞赛*/
            workLoadRow.createCell(8).setCellValue(tjb.getYjsjsgzl()+tjb.getYjslwgzl());
            /*研究生其他*/
            workLoadRow.createCell(9).setCellValue(tjb.getYjsqtgzl());
            /*本科生最低授课*/
            workLoadRow.createCell(10).setCellValue(tjb.getBkszdsk());
            /*额定工作量*/
            workLoadRow.createCell(11).setCellValue(tjb.getEdgzl());
            /*实际教学工作量*/
            workLoadRow.createCell(12).setCellValue(tjb.getSjjxgzl());
            /*本科生授课未完成*/
            workLoadRow.createCell(13).setCellValue(tjb.getBksskwwc());
            /*额定未完成*/
            workLoadRow.createCell(14).setCellValue(tjb.getEdjxwwc());

            if (tjzt.getYjstjzt()==0){
                /*提交状态*/
                workLoadRow.createCell(15).setCellValue("未提交");
            }else {
                workLoadRow.createCell(15).setCellValue("已提交");
            }

            if (tjzt.getYjsshzt()==0 || tjzt.getYjsshzt()==1){
                /*提交状态*/
                workLoadRow.createCell(16).setCellValue("未审核");
            }else if(tjzt.getYjsshzt()==2){
                workLoadRow.createCell(16).setCellValue("院系已审核");
            }else if(tjzt.getYjsshzt()==3){
                workLoadRow.createCell(16).setCellValue("研究生处已审核");
            }
        }
        /*响应给浏览器*/
        try {
    ...
    /*本科生1*/
    @NeedLogin
    @RequestMapping("QXexcelOut1")
    public void QXexcelOut1(HttpServletRequest request, HttpServletResponse response, Users users) {
        /*创建Excel，设置基本样式*/
        HSSFWorkbook sheets = new HSSFWorkbook();
        HSSFCellStyle cellStyle = sheets.createCellStyle();
        HSSFFont font = sheets.createFont();
        ...
        workLoad.addMergedRegion(cellRangeAddress1);
        cell.setCellStyle(cellStyle1);
        cell.setCellValue("湖北师范大学"+ GetYear.getCurrentYear() +"年度教师本科生教学工作量统计表");
        ...
        /*取出数据*/
        List<Tjb> tjbs = null;
        if(users.getActor()==2 || users.getActor()==4){
             tjbs = tjbService.getAllTjbByYxbm(users.getYxbm(), users.getYxbm());
        }else {
             tjbs = tjbService.getAllTjb(GetYear.getCurrentYear());
        }
        ...
        for (int i = 0; i < tjbs.size(); i++) {
            ...
            if (tjzt.getBksshzt()==0 || tjzt.getBksshzt()==1){
                /*提交状态*/
                workLoadRow.createCell(16).setCellValue("未审核");
            }else if(tjzt.getBksshzt()==2){
                workLoadRow.createCell(16).setCellValue("院系已审核");
            }else if(tjzt.getBksshzt()==3){
                workLoadRow.createCell(16).setCellValue("教务处已审核");
            }

        }
        /* 设置自动列宽 */
        for (int i = 0; i < tjbs.size(); i++) {
            workLoad.autoSizeColumn(i);
            workLoad.setColumnWidth(i,workLoad.getColumnWidth(i) * 2);
        }
