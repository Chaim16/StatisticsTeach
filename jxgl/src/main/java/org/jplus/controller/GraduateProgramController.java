...
//主要数据
    ...
    public String graduateProgramInfo(Model model, Users user){
        ...
        model.addAttribute("hidden",tjztService.getTjzt(user.getGh()).getYjstjzt());
...
//教研项目删除
    ...
    public String delYjsjyxm(Integer id,Users user){
        //提交状态处于0，表示未提交可以操作数据
        if (tjztService.getTjzt(user.getGh()).getYjstjzt() == 0) {
...
//教研项目新增
    ...
    public String addYjsjyxm(Yjsjyxm yjsjyxm,Users user){
        if (tjztService.getTjzt(user.getGh()).getYjstjzt() == 0) {
            ...
            //获取年度
            yjsjyxm.setNd(GetYear.getCurrentYear());
            //获取工作量
...
//研究生横向项目新增
    ...
    public String addYjshxxm(Yjshxxm yjshxxm, Users user){
        if (tjztService.getTjzt(user.getGh()).getYjstjzt() == 0) {
            ...
            //获取年度
            yjshxxm.setNd(GetYear.getCurrentYear());
            //获取工作量
