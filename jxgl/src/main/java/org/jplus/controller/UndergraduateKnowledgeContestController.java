...
public class UndergraduateKnowledgeContestController {
    ...
    public String hello(Model model,Users users) {
        List<ZdxsjsVo> list = zDXSJSService.getStudentCompetitionList(users.getGh(), xqnd);
        ...
        List<JsjsVo> result = jSJSService.getTeacherCompetitionList(users.getGh(), xqnd);
        // 向竞赛等级编码表中查询
        ...
        ZDXSLW zDXSLW = zDXSJSService.findZDXSLWByGhAndYear(users.getGh(), xqnd);
    ...
    public Float getStudentCompetitionGzl(Users users) {
        if(zDXSJSService.getAllGzl(users.getGh(), DateUtils.getCurrentYear()) != null) {
            return zDXSJSService.getAllGzl(users.getGh(), xqnd);
        }else {
            return 0.0f;
        }
    }
    ...
    public Float getTeacherCompetitionGzl(Users users) {
        if(jSJSService.getAllGzl(users.getGh(), DateUtils.getCurrentYear()) != null) {
            return jSJSService.getAllGzl(users.getGh(), xqnd);
        }else {
            return 0.0f;
        }
    }
    ...
    public Float getLwGzl(Users users) {
        return jSJSService.getAllLwGzl(users.getGh(), xqnd);
    }
    ...
    public Float getAllGzl(Users users) {
        float result = 0;
        if(zDXSJSService.getAllGzl(users.getGh(), DateUtils.getCurrentYear()) != null) {
            Object temp = zDXSJSService.getAllGzl(users.getGh(), xqnd);
            if(temp != null)
               result += (Float) temp;
        }
        if(jSJSService.getAllGzl(users.getGh(), DateUtils.getCurrentYear()) != null) {
            Object temp =  jSJSService.getAllGzl(users.getGh(), xqnd);
            if(temp != null)
            result += (Float) temp;
        }
        if(jSJSService.getAllLwGzl(users.getGh(), DateUtils.getCurrentYear()) != null) {
            Object temp = jSJSService.getAllLwGzl(users.getGh(), xqnd);
            if(temp != null)
                  result += (Float) temp;
        }
        return result;
    ...
    @NeedLogin
    @RequestMapping("/selectKnowByYear")
    public String selectKnowByYear(@ModelAttribute(value = "xqnd")Integer xqnd){
        this.xqnd = xqnd;
        return "redirect:know";
    }
}
